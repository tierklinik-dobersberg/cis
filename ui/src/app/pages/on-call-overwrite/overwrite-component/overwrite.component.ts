...
import { CreateOverwriteRequest, GetOverwriteResponse, Overwrite } from '@tierklinik-dobersberg/apis/pbx3cx/v1';
import { GetRequiredShiftsResponse, GetWorkingStaffResponse, PlannedShift, WorkShift } from '@tierklinik-dobersberg/apis/roster/v1';
