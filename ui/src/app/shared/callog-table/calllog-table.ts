import { Component, OnDestroy, OnInit, Output, TrackByFunction, EventEmitter, Input } from '@angular/core';
import { sum } from 'ng-zorro-antd/core/util';
import { Subscription, BehaviorSubject, Subject, combineLatest, interval, of, Observable, forkJoin } from 'rxjs';
import { startWith, mergeMap, catchError } from 'rxjs/operators';
import { CallLog, ProfileWithAvatar, CalllogAPI, ConfigAPI, IdentityAPI, SearchParams } from 'src/app/api';
import { Customer, CustomerAPI } from 'src/app/api/customer.api';
import { LayoutService } from 'src/app/layout.service';
import { HeaderTitleService } from '../header-title';
