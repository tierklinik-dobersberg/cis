...
import { EventEmitter, ChangeDetectionStrategy, Component, forwardRef, Input, Output, TrackByFunction, ChangeDetectorRef } from "@angular/core";
...
@Component({
  ...
  providers: [
    { provide: NG_VALUE_ACCESSOR, multi: true, useExisting: forwardRef(() => TkdStringSliceInputComponent)},
  ]
})
